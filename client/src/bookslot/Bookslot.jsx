...
export const Bookslot = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (value <= slotcount) {
        await axios.post(
          "https://covid-app-backend.onrender.com/book",
          { book, selectloc, selectdate, selectslot, value, slotname },
          {
  ...
  useEffect(() => {
    const fetchdata = async () => {
      const res = await axios.get(
        "https://covid-app-backend.onrender.com/add/loc"
      );
  ...
  const fetchView = async (e) => {
    ...
    try {
      const res = await axios.post(
        "https://covid-app-backend.onrender.com/add/view",
        { selectloc, selectdate },
        {
          withCredentials: true,
        }
      );
        ...
        <div className="right">
          <div className="slots">
              ...
              <div className="con">
                ...
                <Select
                  ...
                  onChange={(selectedOption) =>
                    setSelectloc(selectedOption.value)
                  }
                  options={optionval}
                  isSearchable
            ...
            <div className="bottom">
              <Button variant="contained" className="btn" onClick={fetchView}>
                View
              </Button>
            </div>
          </div>
                ...
                >
                  <div className="grp">
                    ...
                    <FormControlLabel
                      name="slot1"
                      onChange={() => {
                        setAvacount(data[0].rem1);
                        setSlotcount(data[0].s1);
                        setSlotname("rem1");
                      }}
                      value={`${data[0]?.slot1}`}
                      control={<Radio />}
                  ...
                  <div className="grp">
                    ...
                    <FormControlLabel
                      name="slot2"
                      onChange={() => {
                        setAvacount(data[0].rem2);
                        setSlotcount(data[0].s2);
                        setSlotname("rem2");
                      }}
                      value={`${data[0]?.slot2}`}
                      control={<Radio />}
                  ...
                  <div className="grp">
                    ...
                    <FormControlLabel
                      name="slot3"
                      onChange={() => {
                        setAvacount(data[0].rem3);
                        setSlotcount(data[0].s3);
                        setSlotname("rem3");
                      }}
                      value={`${data[0]?.slot3}`}
                      control={<Radio />}
